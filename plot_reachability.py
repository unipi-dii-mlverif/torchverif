...
feat_1 = torch.distributions.uniform.Uniform(9, 10).sample([samples])
feat_2 = torch.distributions.uniform.Uniform(9, 10).sample([samples])
...
intervals = np.array([[9, 10], [9, 10]], dtype=object)
...
plt.scatter(p0[:, 1], p0[:, 0], s=0.60, marker="+")
plt.scatter(p1[:, 1], p1[:, 0], s=0.60, marker="+")
plt.scatter(p2[:, 1], p2[:, 0], s=0.60, marker="+")
plt.scatter(p3[:, 1], p3[:, 0], s=0.60, marker="+")
